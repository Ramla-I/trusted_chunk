...
pub struct StaticArray  {
    pub(crate) arr: [Option<PageRange>; 64] // only public so it can be used in spec
}
...
impl StaticArray {
    ...
    pub fn lookup(&self, index: usize) -> Option<PageRange> {
        self.arr[index]
    }
	...
	pub(crate) fn push(&mut self, value: PageRange) -> Result<usize,()> {
        let mut i = 0;
    ...
    pub(crate) fn elem_overlaps_in_array(&self, elem: PageRange, index: usize) -> Option<usize> {
